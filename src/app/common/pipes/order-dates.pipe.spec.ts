...
//     const class1 = createClassWithAll(
//         '1',
//         null,
//         null,
//         null,
...
//         null
//     );
//     const class2 = createClassWithAll(
//         '2',
//         null,
//         null,
//         null,
//         moment(new Date('02/02/18').toISOString()),
//         null
//     );
//     const class3 = createClassWithAll(
//         '3',
//         null,
//         null,
//         null,
//         moment(new Date('03/02/18').toISOString()),
//         null
//     );
//     const class4 = createClassWithAll(
//         '4',
//         null,
//         null,
//         null,
//         moment(new Date('04/02/18').toISOString()),
//         null
//     );
//     const class5 = createClassWithAll(
//         '5',
//         null,
//         null,
//         null,
//         moment(new Date('05/02/18').toISOString()),
//         null
//     );
//
//     const unorderedDates = [class2, class4, class1, class5, class3];
//
//     const expectedAscendingDates = [class1, class2, class3, class4, class5];
//
//     const expectedDescendingDates = [class5, class4, class3, class2, class1];
//
