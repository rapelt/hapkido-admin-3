...
import * as authentication from '../auth-state/authentication.reducers';
import * as student from '../student-state/students.reducers';
import * as classes from '../classes-state/classes.reducers';
import * as techniques from '../technique-state/techniques.reducers';
