...
describe('Authentication reducers', () => {
    it('should sign out user', () => {
        ...
        expect(
            reducer.authenticationReducer(authentication, new SignOutSuccess())
    ...
    it('should sign in user', () => {
        ...
        expect(
            reducer.authenticationReducer(authentication, new SignInSuccess({}))
        ).toEqual(expectedAuthentication);
    });
    ...
    it('should return default', () => {
        ...
        expect(
            reducer.authenticationReducer(authentication, new SignOut())
