...
import {
  ...
  selectSelectedStudentGradingDates, selectSelectedStudentsLastClass
...
describe('Student Selectors', () => {
  ...
  it('selectSelectedStudent should return a student', () => {
    ...
    expect(selectSelectedStudent(activeStudent.hbId)(state)).toEqual(activeStudent);
  });
  ...
  it('selectSelectedStudentGradingDates should return a students grading dates', () => {
    ...
    expect(selectSelectedStudentGradingDates(activeStudent.hbId)(state)).toEqual(activeStudent.gradingDates);
  });

  it('selectSelectedStudentClassDates should return a list of class that the student attended', () => {
    const studentWhoAttendedClasses = createStudentAll(null, null, 'hb003', null, null, null, false);

    const classWithStudent = createClassWithAll( null, null, ['hb003']);
    const classWithoutStudent = createClassWithAll(null, null, ['hb002']);
    const classWithStudent2 = createClassWithAll(null, null, ['hb002', 'hb003']);
    ...
    expect(selectSelectedStudentClassDates(studentWhoAttendedClasses.hbId)(state)).toEqual([classWithStudent, classWithStudent2]);
  });
  ...
  it('selectSelectedStudentFamilyMembers should return a students family members', () => {
    ...
    expect(selectSelectedStudentFamilyMembers(studentWithFamilyMember.hbId)(state)).toEqual([familyMember, anotherFamilyMember]);
  });

  it('selectSelectedStudentLastClass should return the latest class a student attended', () => {
    const studentWhoAttendedClasses = createStudentAll(null, null, 'hb003', null, null, null, false);

    const classWithStudent = createClassWithAll( null, null, ['hb003'], null, moment('01/02/03'));
    const classWithStudent2 = createClassWithAll( null, null, ['hb003'], null, moment('29/01/03'));
    const classWithStudent3 = createClassWithAll( null, null, ['hb003'], null, moment('01/02/03'));

    const classWithoutStudent = createClassWithAll(null, null, ['hb002'], null, moment('02/02/03'));
    const lastClassWithStudent = createClassWithAll(null, null, ['hb002', 'hb003'], null, moment('03/02/03'));
    ...
    const classesState: ClassesState = {
      classes: [ classWithoutStudent, classWithStudent, lastClassWithStudent, classWithStudent2, classWithStudent3 ],
      selectedClass: null,
    };
    ...
    expect(selectSelectedStudentsLastClass(studentWhoAttendedClasses.hbId)(state)).toEqual(lastClassWithStudent);
  });
