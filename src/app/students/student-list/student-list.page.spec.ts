...
import { MockPopOverController, MockToastController } from '../../../testing-helpers/ionic.mocks';
...
describe('StudentListPage Active', () => {
  ...
  const initialState = {
    students: {
      students: [
        { isActive: true,  name: { firstname: 'a', lastname: 'a'}, grade: 1},
        { isActive: true,  name: { firstname: 'b', lastname: 'b'}, grade: 1 },
        { isActive: true,  name: { firstname: 'c', lastname: 'c'}, grade: 1 },
      ]
    }
  };
